...
static void ble_gatt_on_register(struct ble_gatt_register_ctxt *ctxt,
                                 void *arg) {
  ...
  case BLE_GATT_REGISTER_OP_CHR:
    ESP_LOGI(TAG,
             "registered characteristic %s with "
...
void ble_gatt_start(void) { nimble_port_freertos_init(ble_host_task); }
